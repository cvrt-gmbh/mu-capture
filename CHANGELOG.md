...
### Fixed
- **App icon** - Fixed white corners, now has proper transparency
...
### Fixed
- **Camera authorization** - App now properly requests camera permission on first launch
- **Permission denied UI** - Shows clear message with "OPEN SETTINGS" button when camera access is denied
...
|---------|------|---------|
| 1.0.10 | 2026-02-03 | Fix app icon white corners |
...
[Unreleased]: https://github.com/cvrt-gmbh/mu-capture/compare/v1.0.10...HEAD
[1.0.10]: https://github.com/cvrt-gmbh/mu-capture/compare/v1.0.9...v1.0.10
